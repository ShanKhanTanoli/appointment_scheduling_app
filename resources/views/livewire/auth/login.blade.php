                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            <h3 class="font-weight-bolder text-primary text-gradient">{{ __('Welcome back') }}</h3>
                            <p class="mb-0">{{ __('Create a new acount')}}<br></p>
                            <p class="mb-0">{{__('OR Sign in with these credentials:') }}</p>
                            <p class="mb-0">{{ __('Email ') }}<b>{{ $email }}</b></p>
                            <p class="mb-0">{{ __('Password ') }}<b>{{ $password }}</b></p>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer text-center pt-0 px-lg-2 px-1">
                            <small class="text-muted">{{ __('Forgot you password? Reset you password') }} <a
                                    ...
                                    class="text-primary text font-weight-bold">{{ __('here') }}</a></small>
